...
if st.session_state.page == "input":
    ...
    urea = st.number_input("Kadar Urea dalam Darah (mg/dL)", min_value=1.1, max_value=26.40, value=5.0, step=0.1)
    cr = st.number_input("Kadar Kreatinin dalam Darah (mg/dL)", min_value=6, max_value=800, value=7, step=1)
    ...
    hdl = st.number_input("High-Density Lipoprotein (mg/dL)", min_value=0.4, max_value=4.0, value=2.0, step=0.1)
    ldl = st.number_input("Low-Density Lipoprotein (mg/dL)", min_value=0.3, max_value=5.6, value=2.0, step=0.1)
    vldl = st.number_input("Very Low-Density Lipoprotein (mg/dL)", min_value=0.2, max_value=31.8, value=2.0, step=0.1)
